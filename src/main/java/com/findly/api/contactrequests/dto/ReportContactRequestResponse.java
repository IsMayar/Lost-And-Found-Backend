...
public record ReportContactRequestResponse(
        UUID id,
    ...
    public static ReportContactRequestResponse fromContactRequest(ReportContactRequest contactRequest) {
        Report report = contactRequest.getReport();

        return new ReportContactRequestResponse(
